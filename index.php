        ...
        <div class="column">
            ...
            <div class="accordion">
                ...
                <details>
                    ...
                    <div><h5>Create a PHP class called <code>"Person"</code> with the following properties and methods:</h5></div>
                   ...
                   <div>
                    ...
                    <div><h5> Create an instance of the Person class and set the name and email properties. Use the <code>getName()</code> and <code>getEmail()</code> methods to display the properties on the webpage.</h5></div>
                </details>
                <details>
                    <summary>Task 3: Super-global Variables in PHP</summary>
                    Create a PHP script that retrieves the user's name and email from the HTML form in Task 1 using the <code>$_POST</code> superglobal variable. Create a new instance of the Person class and use the <code>setName()</code> and <code>setEmail()</code> methods to set the name and email properties based on the form data. Use the <code>getName()</code> and <code>getEmail()</code> methods to display the properties on the webpage.
                </details>
            </div>
            <div>
